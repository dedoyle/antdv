<template>
  ...
  >
    <div class="cropper-box" v-if="imgs">
      ...
      >
        <img :src="imgs" style="width: 100%; height: 100%;" alt="cropper-img" ref="cropperImg" />
      </div>
    </div>
    <div
...
export default {
  ...
  methods: {
    ...
    goAutoCrop(cw, ch) {
      ...
      if (this.centerBox) {
        const imgW = this.trueWidth * this.scale
        const imgH = this.trueHeight * this.scale
